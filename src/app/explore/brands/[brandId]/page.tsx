          ...
          <div className="space-y-8">
            ...
            <div>
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100">{brand.name}</h1>
                  {brand.description && (
                    <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">{brand.description}</p>
                  )}
                </div>
              </div>
