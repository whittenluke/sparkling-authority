          ...
          <div className="space-y-8">
            ...
            <div>
              <div className="flex items-center gap-6">
                ...
                <div className="h-32 w-32 rounded-xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-400 dark:text-gray-500">
                ...
                <div>
                  ...
                  <p className="mt-2 text-lg text-gray-600 dark:text-gray-400">{product.description}</p>
              ...
              <dl className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-4">
                <div className="rounded-lg bg-white dark:bg-gray-800 px-4 py-3 shadow-sm ring-1 ring-gray-200 dark:ring-gray-700">
                  <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Carbonation</dt>
                ...
                <div className="col-span-2 rounded-lg bg-white dark:bg-gray-800 px-4 py-3 shadow-sm ring-1 ring-gray-200 dark:ring-gray-700">
                  <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Available Containers</dt>
            ...
            {/* Flavor Tags */}
            <div>
              <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">Flavors</h2>
              <div className="mt-2 flex flex-wrap gap-2">
                {product.flavor.map((flavor: string) => (
                  <span
                    key={flavor}
                    className="inline-flex items-center rounded-full bg-blue-50 dark:bg-blue-900/50 px-3 py-1 text-sm font-medium text-blue-700 dark:text-blue-300 ring-1 ring-inset ring-blue-700/10 dark:ring-blue-400/30"
                  >
                    {flavor}
                  </span>
                ))}
            ...
            <div>
              <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">Nutrition Facts</h2>
              <div className="mt-4 rounded-lg bg-white dark:bg-gray-800 shadow-sm ring-1 ring-gray-200 dark:ring-gray-700">
                <dl className="divide-y divide-gray-200 dark:divide-gray-700">
                  <div className="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Serving Size</dt>
                  ...
                  <div className="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Total Fat</dt>
                    <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100 sm:col-span-2 sm:mt-0">
                      {nutrition.total_fat}g
                    </dd>
                  </div>
                  <div className="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Sodium</dt>
                    <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100 sm:col-span-2 sm:mt-0">
                      {nutrition.sodium}mg
                    </dd>
                  </div>
                  <div className="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Total Carbohydrates</dt>
                    <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100 sm:col-span-2 sm:mt-0">
                      {nutrition.total_carbohydrates}g
                    </dd>
                  </div>
                  <div className="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">Total Sugars</dt>
                    <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100 sm:col-span-2 sm:mt-0">
            ...
            <div className="rounded-lg bg-gray-50 dark:bg-gray-800 px-4 py-6">
              <div className="text-center">
                <h3 className="text-sm font-medium text-gray-900 dark:text-gray-100">Coming Soon</h3>
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
