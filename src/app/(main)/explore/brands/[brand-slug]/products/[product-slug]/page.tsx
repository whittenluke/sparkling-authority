          ...
          <div className="space-y-8">
            ...
            <div>
              <div className="flex items-center gap-6">
                {/* Product Image */}
                {product.thumbnail ? (
                  <div className="h-32 w-32 rounded-xl overflow-hidden bg-muted flex items-center justify-center shrink-0">
                    <Image
                  ...
                  <div className="h-32 w-32 rounded-xl bg-muted flex items-center justify-center text-muted-foreground shrink-0">
